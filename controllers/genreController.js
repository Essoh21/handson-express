...
//import async handler to automaticaly handle thrown errors and not use try catch from
const asyncHandler = require("express-async-handler");

//import express-validator modules to handle validation and sanitization on server
